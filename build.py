"""Inline raw.json + config + holidays into template.html -> dist/index.html.

Usage: python3 build.py [--raw raw.json] [--out dist/index.html] [--anonymize-repos]
...
def main():
    ...
    ap.add_argument("--raw", default=f"{D}/raw.json")
    ap.add_argument("--out", default=f"{D}/dist/index.html")
